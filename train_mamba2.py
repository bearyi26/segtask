...
from models.mamba2 import mamba2_seg_tiny
...
def criterion_mamba(predictions, targets):
...
if __name__ == "__main__":  # this is to correctly handle relevant process
    ...
    for epoch in range(start_epoch, CONFIG["num_epochs"]):
        ...
        # Training
        train_loss = train_one_epoch(model, train_loader, optimizer, criterion_mamba, device)
